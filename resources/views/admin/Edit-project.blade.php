          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" id="inputName" name="name" class="form-control" value="{{$project->name}}">
              </div>
              <div class="form-group">
                <label for="inputDescription">Project Description</label>
                <textarea id="inputDescription" class="form-control" rows="7">
              ...
              <div class="form-group">
                ...
                <input type="text" id="inputProjectLeader" class="form-control" name="leader" value="{{$project->leader}}">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card card-secondary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="number" id="inputSpentBudget" class="form-control" name="target_fund" value="{{$project->target_fund}}" step="1">
              </div>
              <div class="form-group">
                <label for="inputEstimatedDuration">Estimated project duration</label>
                <input type="number" id="inputEstimatedDuration" class="form-control" value="20" step="0.1">
                <input type="text" value="{{$project->id}}" name="projectId">
              </div>
            </div>
          </div>
        </div>
